...
$download_img = new download_image('D:/web/images/',0);   //实例化下载图片对象

/*
$download_img->recursive_download_images('http://www.sxhrtjx.cn/');
*/      //递归抓取图片方法
$download_img->download_current_page_images('http://www.sxhrtjx.cn/');     //只抓取当前页面图片方法
